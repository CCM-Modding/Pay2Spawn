...
package ccm.libs.javazoom.jl.player.advanced;

import java.io.InputStream;

import ccm.libs.javazoom.jl.decoder.Bitstream;
import ccm.libs.javazoom.jl.decoder.BitstreamException;
import ccm.libs.javazoom.jl.decoder.Decoder;
import ccm.libs.javazoom.jl.decoder.Header;
import ccm.libs.javazoom.jl.decoder.JavaLayerException;
import ccm.libs.javazoom.jl.decoder.SampleBuffer;
import ccm.libs.javazoom.jl.player.AudioDevice;
import ccm.libs.javazoom.jl.player.FactoryRegistry;

/**
 * a hybrid of ccm.libs.javazoom.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
