...
public class ChallengeAuthenticator extends Authenticator
{
     ...
     * @param challengeScheme The authentication scheme to use.
     ...
     * @param challengeScheme The authentication scheme to use.
     * @param realm           The authentication realm.
     * @param verifier        The credentials verifier.
     */
     ...
     * received.
     *
     * @param rechallenging True if invalid credentials result in a new challenge.
     * @see #isRechallenging()
     */
