...
public abstract class Authenticator extends Filter
{
     ...
     *
     * @param context  The context.
     * @param optional Indicates if the authenticator is not required to succeed.
     ...
     *
     * @param context             The context.
     * @param multiAuthenticating Indicates if the authenticator should attempt to authenticate
     *                            an already authenticated client.
     * @param optional            Indicates if the authenticator is not required to succeed.
     * @param enroler             The enroler to invoke upon successful authentication.
     */
    ...
    protected int authenticated(Request request, Response response)
    {
        ...
        if (loggable && request.getChallengeResponse() != null)
        {
            getLogger().log(Level.FINE,
                    "The authentication succeeded for the identifer \"" + request.getChallengeResponse().getIdentifier() + "\" using the " + request.getChallengeResponse().getScheme() + " scheme.");
        }
     ...
     *
     * @param enroler The enroler invoked upon successful authentication.
     */
     ...
     * to true.
     *
     * @param multiAuthenticating True if the authenticator should attempt to authenticate an
     *                            already authenticated client.
     */
     ...
     * authentications.
     *
     * @param optional True if the authentication success is optional.
     */
    ...
    protected int unauthenticated(Request request, Response response)
    {
        ...
        {
            getLogger().log(Level.FINE,
                    "The authentication failed for the identifer \"" + request.getChallengeResponse().getIdentifier() + "\" using the " + request.getChallengeResponse().getScheme() + " scheme.");
        }
