...
public class TemplateRoute extends Route
{
     ...
     * reference.
     *
     * @param matchingMode The matching mode to use.
     */
     ...
     * string.
     *
     * @param matchingQuery True if the matching should be done with the query string,
     *                      false otherwise.
     */
     ...
     *
     * @param template The reference template to match.
     */
    ...
    {
        return "\"" + ((getTemplate() == null) ? super.toString() : getTemplate().getPattern()) + "\" -> " + ((getNext() == null) ? "null" : getNext().toString());
    }
}
