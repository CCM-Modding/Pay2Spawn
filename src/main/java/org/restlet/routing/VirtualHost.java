...
public class VirtualHost extends Router
{
     ...
     *
     * @param code The thread's virtual host code.
     */
     ...
     *
     * @param parentContext The parent component's context.
     */
     ...
     *
     * @param parentContext  The parent component's context.
     * @param hostDomain     The hostRef host domain pattern to match.
     * @param hostPort       The hostRef host port pattern to match.
     * @param hostScheme     The hostRef scheme protocol pattern to match.
     ...
     * {@link java.util.regex.Pattern} class for details on the syntax.
     *
     * @param hostDomain The hostRef host domain to match.
     */
     ...
     * {@link java.util.regex.Pattern} class for details on the syntax.
     *
     * @param hostPort The hostRef host port to match.
     */
     ...
     *
     * @param hostScheme The hostRef scheme to match.
     */
