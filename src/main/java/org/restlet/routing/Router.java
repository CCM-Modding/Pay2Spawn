...
public class Router extends Restlet
{
     ...
     *
     * @param pathTemplate The URI path template that must match the relative part of the
     *                     resource URI.
     * @param targetClass  The target Resource class to attach.
     * @return The created route.
     */
     ...
     * calls to 1.0.
     *
     * @param defaultTargetClass The target Resource class to attach.
     * @return The created route.
     */
     ...
     * 1.0.
     *
     * @param defaultTarget The Restlet to use as the default target.
     * @return The created route.
     */
     ...
     *
     * @param uriPattern The URI pattern that must match the relative part of the
     *                   resource URI.
     * @param target     The target Restlet to attach.
     * @return The created route.
     */
     ...
     *
     * @param defaultMatchingMode The default matching mode.
     */
     ...
     * to false.
     *
     * @param defaultMatchingQuery The default setting for whether the routing should be done on
     *                             URIs with or without taking into account query string.
     */
     ...
     *
     * @param defaultRoute The default route tested if no other one was available.
     */
     ...
     *
     * @param retryDelay The delay in milliseconds before a new attempt is made.
     */
