...
public final class Variable
{
     ...
     *
     * @param type The type of variable. See TYPE_* constants.
     */
     ...
     *
     * @param type         The type of variable. See TYPE_* constants.
     * @param defaultValue The default value to use if the key couldn't be found in the
     *                     model.
     * @param required     Indicates if the variable is required or optional.
     * @param fixed        Indicates if the value is fixed, in which case the
     ...
     * @param fixed            Indicates if the value is fixed, in which case the
     *                         "defaultValue" property is always used.
     * @param decodingOnParse  Indicates if the parsed value must be decoded.
     * @param encodingOnFormat Indicates if the formatted value must be encoded.
     */
     ...
     * Indicates if the parsed value must be decoded.
     *
     * @param decodingOnParse True if the parsed value must be decoded, false otherwise.
     */
     ...
     * Indicates if the formatted value must be encoded.
     *
     * @param encodingOnFormat True if the formatted value must be encoded, false otherwise.
     */
     ...
     *
     * @param fixed True if the value is fixed
     */
     ...
     * Indicates if the variable is required or optional.
     *
     * @param required True if the variable is required or optional.
     */
