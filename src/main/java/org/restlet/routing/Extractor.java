...
public class Extractor extends Filter
{
    ...
    private static final class ExtractInfo
    {
         ...
         * @param first     Indicates how to handle repeating values.
         */
     ...
     *
     * @param attribute  The name of the request attribute to set.
     * @param cookieName The name of the cookies to extract.
     * @param first      Indicates if only the first cookie should be set. Otherwise as
     ...
     *
     * @param attribute The name of the request attribute to set.
     * @param parameter The name of the entity form parameter to extract.
     * @param first     Indicates if only the first cookie should be set. Otherwise as
     *                  a List instance might be set in the attribute value.
     */
     ...
     *
     * @param attribute The name of the request attribute to set.
     * @param parameter The name of the query string parameter to extract.
     * @param first     Indicates if only the first cookie should be set. Otherwise as
     *                  a List instance might be set in the attribute value.
     */
