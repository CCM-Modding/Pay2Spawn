...
public class TunnelService extends Service
{
     ...
     * @param preferencesTunnel Indicates if the client preferences can be tunneled by query
     ...
     *
     * @param enabled           True if the service has been enabled.
     * @param methodTunnel      Indicates if the method can be tunneled using a query
     *                          parameter.
     * @param preferencesTunnel Indicates if the client preferences can be tunneled using
     ...
     * @param extensionsTunnel  Indicates if tunneling can use file-like extensions.
     * @param userAgentTunnel   Indicates if tunneling can use user agent string.
     * @param headersTunnel     Indicates if method can be tunneled via a specific header.
     */
     ...
     * parameters.
     *
     * @param preferencesTunnel True if the client preferences can be tunneled via the query
     *                          parameters.
     */
     ...
     * parameters.
     *
     * @param queryTunnel True if the method and client preferences can be tunneled via
     *                    query parameters.
     */
     ...
     * agent.
     *
     * @param userAgentTunnel True if the client preferences can be tunneled according to
     *                        the user agent.
     */
