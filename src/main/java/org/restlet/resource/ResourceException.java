...
public class ResourceException extends RuntimeException
{
     ...
     * Constructor.
     *
     * @param code The specification code of the encapsulated status.
     */
     ...
     *
     * @param code        The specification code of the encapsulated status.
     * @param name        The name of the encapsulated status.
     * @param description The description of the encapsulated status.
     ...
     * @param description The description of the encapsulated status.
     * @param uri         The URI of the specification describing the method.
     * @param cause       The wrapped cause error or exception.
     */
