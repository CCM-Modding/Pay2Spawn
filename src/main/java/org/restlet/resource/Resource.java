...
public abstract class Resource
{
    ...
    {
        getLogger().log(Level.INFO, "Exception or error caught in resource", throwable);
    }

    /**
     * Invoked when an error response status is received.
     *
     * @param errorStatus The error status received.
     */
    ...
    {
        return getRequest() == null ? null : getRequest().getProxyChallengeResponse();
    }
    ...
    {
        return getResponse() == null ? null : getResponse().getCacheDirectives();
    }
