...
public class Directory extends Finder
{
     ...
     * @param rootLocalReference The root URI.
     */
     ...
     *
     * @param context The context.
     * @param rootUri The absolute root URI. <br>
     *                <br>
     ...
     * @param indexContent The directory index to represent.
     ...
     *
     * @param comparator The reference comparator.
     */
     ...
     * file is found.
     *
     * @param listingAllowed True if the display of directory listings is allowed when no
     *                       index file is found.
     */
     ...
     *
     * @param modifiable True if modifications to local resources are allowed.
     */
     ...
     * is true.
     *
     * @param negotiatingContent True if the best content is automatically negotiated.
     */
