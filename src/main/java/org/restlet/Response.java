...
public class Response extends Message
{
     ...
     *
     * @param response The thread's response.
     */
     ...
     * "Authentication-Info" header.
     *
     * @param authenticationInfo The data returned by the server in response to successful
     *                           authentication.
     */
     ...
     *
     * @param challengeRequests A list of authentication requests sent by an origin server to
     *                          a client.
     */
     ...
     *
     * @param cookieSettings A series of cookie settings provided by the server.
     */
     ...
     * list.
     *
     * @param proxyChallengeRequests A list of authentication requests sent by a proxy to a client.
     */
     ...
     * "Retry-After" header.
     *
     * @param retryAfter Date after with a retry attempt could occur.
     */
