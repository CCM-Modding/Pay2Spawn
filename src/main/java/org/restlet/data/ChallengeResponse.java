...
public final class ChallengeResponse extends ChallengeMessage
{
     ...
     * @param secret           The user secret, such as a password or a secret key, with no
     *                         digest applied.
     */
     ...
     * @param response         The latest server response.
     * @param identifier       The user identifier, such as a login name or an access key.
     * @param secret           The user secret used to compute the secret, with an optional
     *                         digest applied.
     * @param secretAlgorithm  The digest algorithm of the user secret (see {@link Digest}
     *                         class).
     */
     ...
     * @param identifier        The user identifier, such as a login name or an access key.
     * @param secret            The user secret, such as a password or a secret key.
     * @param secretAlgorithm   The digest algorithm name optionally applied on the user
     *                          secret.
     * @param realm             The authentication realm.
     * @param quality           The chosen quality of protection.
     * @param digestRef         The {@link Request#getResourceRef()} value duplicated here in
     *                          case a proxy changed it.
     * @param digestAlgorithm   The digest algorithm.
     * @param opaque            An opaque string of data which should be returned by the
     *                          client unchanged.
     * @param clientNonce       The client nonce value.
     * @param serverNonce       The server nonce.
     * @param serverNounceCount The server nonce count.
     * @param timeIssued        The time when the response was issued, as returned by
     *                          {@link System#currentTimeMillis()}.
     */
    ...
    {
        this(scheme, parameters, identifier, secret, Digest.ALGORITHM_NONE, null, null, null, null, null, null, null, 0, 0L);
    }
     ...
     *
     * @param secretDigestAlgorithm The digest algorithm name optionally applied on the user
     *                              secret.
     */
