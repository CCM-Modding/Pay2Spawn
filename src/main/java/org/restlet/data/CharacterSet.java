...
public final class CharacterSet extends Metadata
{
     ...
     */
    public static final CharacterSet DEFAULT = new CharacterSet(java.nio.charset.Charset.defaultCharset());
    ...
    {
        return (object instanceof CharacterSet) && getName().equalsIgnoreCase(((CharacterSet) object).getName());
    }
     ...
     * </ul>
     *
     * @param included The character set to test for inclusion.
