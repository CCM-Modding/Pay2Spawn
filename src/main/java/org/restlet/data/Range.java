...
public class Range
{
     ...
     * given size.
     *
     * @param size Size of the range in number of bytes.
     */
     ...
     * Constructor.
     *
     * @param index Index from which to start the range
     * @param size  Size of the range in number of bytes.
     */
     ...
     * default value is {@link #INDEX_FIRST} (0), starting at the first byte
     *
     * @param index The index from which to start the range.
     */
     ...
     * available from the index, then use the {@value #SIZE_MAX} constant.
     *
     * @param size The size of the range in number of bytes.
     */
