...
public class Reference
{
    ...
    static
    {
        ...
        {
            charValidityMap[character] = isReserved(character) || isUnreserved(character) || (character == '%') || (character == '{') || (character == '}');
        }
    }
     ...
     *
     * @param toEncode    The string to encode.
     * @param queryString True if the string to encode is part of a query string instead
     *                    of a HTML form post.
     * @return The encoded string.
     */
     ...
     * @param fragment The optional fragment identifier.
     ...
     *
     * @param url The {@link java.net.URL} instance.
     */
     ...
     * given protocol.
     *
     * @param protocol Protocol/scheme to use
     * @param hostName The host name or IP address.
     */
     ...
     *
     * @param baseRef      The base reference.
     * @param relativePart The relative part component (most of the time it is the path
     *                     component).
     * @param query        The optional query component for hierarchical identifiers.
     * @param fragment     The optional fragment identifier.
     */
     ...
     * necessary.
     *
     * @param uriRef The URI reference to check.
            ...
            if (index != -1)
            {
                ...
                catch (NumberFormatException nfe)
                {
                    Context.getCurrentLogger().log(Level.WARNING,
                            "Can't parse hostPort : [hostRef,requestUri]=[" + getBaseRef() + "," + this.internalRef + "]");
                }
            }
        }
     ...
     * @throws IllegalArgumentException If the relative reference is computed although the reference
     ...
     * @param decode Indicates if the result should be decoded using the
     *               {@link #decode(String)} method.
     * @param query  True if the query part should be returned, false otherwise.
     * @return The optionally decoded remaining part.
     * @see #getRemainingPart()
     */
     ...
     * Note that no URI decoding is done by this method.
     *
     * @param extensions The extensions to set or null (without leading or trailing
     *                   dots).
     * @see #getExtensions()
     * @see #getExtensionsAsArray()
     * @see #setExtensions(String[])
     ...
     *
     * @param fragment The fragment identifier.
     * @throws IllegalArgumentException if the fragment parameter contains the fragment delimiter
     *                                  ('#').
     */
     ...
     * @throws IllegalArgumentException If the identifier parameter contains the fragment delimiter
     *                                  ('#').
     */
