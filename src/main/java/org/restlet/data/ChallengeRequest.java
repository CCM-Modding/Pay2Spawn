...
public final class ChallengeRequest extends ChallengeMessage
{
     ...
     *
     * @param domainUris The base URI references.
     ...
     *
     * @param qualityOptions The available options for quality of protection.
     */
     ...
     * Indicates if the previous request from the client was stale.
     *
     * @param stale True if the previous request from the client was stale.
     */
