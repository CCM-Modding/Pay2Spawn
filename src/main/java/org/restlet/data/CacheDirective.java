...
public final class CacheDirective implements NamedValue<String>
{
    ...
    {
        return new CacheDirective(HeaderConstants.CACHE_MAX_AGE, Integer.toString(maxAge), true);
    }
     ...
     * Note that this directive can be used on requests only.
     *
     * @param maxStale Maximum stale age in seconds.
     * @return A new "max-stale" directive.
     * @see <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.3">HTTP
     * 1.1 - Modifications of the Basic Expiration Mechanism</a>
    ...
    {
        return new CacheDirective(HeaderConstants.CACHE_MAX_STALE, Integer.toString(maxStale), true);
    }
     ...
     * Note that this directive can be used on requests only.
     *
     * @param minFresh Minimum freshness lifetime in seconds.
    ...
    {
        return new CacheDirective(HeaderConstants.CACHE_MIN_FRESH, Integer.toString(minFresh), true);
    }
     ...
     * Note that this directive can be used on requests or responses.
     *
     * @param fieldNames Field names, typically a HTTP header name, that must not be
     *                   sent by caches.
     * @return A new "no-cache" directive.
     * @see <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP
     ...
     * Note that this directive can be used on requests or responses.
     *
     * @param fieldName A field name, typically a HTTP header name, that must not be
     *                  sent by caches.
     * @return A new "no-cache" directive.
     * @see <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP
    ...
    {
        return new CacheDirective(HeaderConstants.CACHE_NO_CACHE, "\"" + fieldName + "\"");
    }
     ...
     * Note that this directive can be used on responses only.
     *
     * @param fieldNames Field names, typically a HTTP header name, that must be
     *                   private.
     * @return A new "private" directive.
     * @see <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP
     ...
     * Note that this directive can be used on responses only.
     *
     * @param fieldName A field name, typically a HTTP header name, that is private.
     * @return A new "private" directive.
     * @see <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP
     * 1.1 - What is Cacheable</a>
     ...
     * Note that this directive can be used on responses only.
     *
     * @param sharedMaxAge Maximum age in seconds.
    ...
    {
        return new CacheDirective(HeaderConstants.CACHE_SHARED_MAX_AGE, Integer.toString(sharedMaxAge), true);
    }
     ...
     * @param name  The directive name.
     * @param value The directive value.
     * @param digit The kind of value (true for a digit value, false otherwise).
     */
     ...
     * Indicates if the directive is a digit value.
     *
     * @param digit True if the directive contains a digit value.
     */
    ...
    {
        return "CacheDirective [digit=" + digit + ", name=" + name + ", value=" + value + "]";
    }
}
