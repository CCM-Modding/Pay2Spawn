...
public final class LocalReference extends Reference
{
     ...
     * Constructor.
     *
     * @param pkg The package to identify.
     */
    ...
    public static LocalReference createClapReference(int authorityType, Package pkg)
    {
        ...
        return new LocalReference("clap://" + getAuthorityName(authorityType) + "/" + pkgPath);
    }
     ...
     * Constructor.
     *
     * @param hostName The authority (can be a host name or the special "localhost"
     *                 or an empty value).
    ...
    {
        return new LocalReference("riap://" + getAuthorityName(authorityType) + path);
    }

    /**
     * Constructor.
     *
     * @param zipFile   The Zip file reference.
     * @param entryPath The entry path inside the Zip file.
     */
