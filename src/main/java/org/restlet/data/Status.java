...
public final class Status
{
    ...
    private static final String BASE_RESTLET = "http://www.restlet.org/documentation/" + Engine.MAJOR_NUMBER + '.' + Engine.MINOR_NUMBER + "/" + Edition.CURRENT.getShortName().toLowerCase() + "/api/";
    ...
    public String getUri()
    {
        ...
        if (result == null)
        {
            switch (this.code)
            {
                ...
                case 1000:
                    result = BASE_RESTLET + "org/restlet/data/Status.html#CONNECTOR_ERROR_CONNECTION";
                    break;
                case 1001:
                    result = BASE_RESTLET + "org/restlet/data/Status.html#CONNECTOR_ERROR_COMMUNICATION";
                    break;
                case 1002:
                    result = BASE_RESTLET + "org/restlet/data/Status.html#CONNECTOR_ERROR_INTERNAL";
                    break;
            }
        }
