...
public abstract class ClientConnectionHelper extends ConnectionHelper<Client>
{
     ...
     * Constructor.
     *
     * @param connector The helped client connector.
     */
    ...
    {
        return new Connection<Client>(this, socketChannel, controller, socketAddress, getInboundBufferSize(), getOutboundBufferSize());
    }
     ...
     *
     * @param secure        Indicates if messages will be exchanged confidentially, for
     *                      example via a SSL-secured connection.
     * @param socketAddress The holder of a host/port pair.
     ...
     * @param secure     Indicates if messages will be exchanged confidentially, for
     *                   example via a SSL-secured connection.
     * @param hostDomain The target host domain name.
     ...
     * @throws UnknownHostException If the proxy port is invalid or the host unresolved.
     */
    ...
    public int getSocketConnectTimeoutMs()
    {
        ...
        {
            result = Integer.parseInt(getHelpedParameters().getFirstValue("socketConnectTimeoutMs", "0"));
        }
