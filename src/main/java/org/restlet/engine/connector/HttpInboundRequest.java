...
public class HttpInboundRequest extends Request implements InboundRequest
{
    ...
    public ClientInfo getClientInfo()
    {
        ...
        if (!this.clientAdded)
        {
            if (getHeaders() != null)
            {
                ...
                result.setFrom(getHeaders().getFirstValue(HeaderConstants.HEADER_FROM));
    ...
    {
        return (Series<Header>) getAttributes().get(HeaderConstants.ATTRIBUTE_HEADERS);
    }
    ...
    public List<Range> getRanges()
    {
        ...
        if (!this.rangesAdded)
        {
            ...
            {
                // Extract the header value
                String ranges = getHeaders().getValues(HeaderConstants.HEADER_RANGE);
    ...
    public List<RecipientInfo> getRecipientsInfo()
    {
        ...
        {
            for (String header : getHeaders().getValuesArray(HeaderConstants.HEADER_VIA))
            {
    ...
    public List<Warning> getWarnings()
    {
        ...
        if (!this.warningsAdded)
        {
            if (getHeaders() != null)
            {
                for (String warning : getHeaders().getValuesArray(HeaderConstants.HEADER_WARNING))
                {
