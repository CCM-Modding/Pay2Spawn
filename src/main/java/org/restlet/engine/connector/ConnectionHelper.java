...
public abstract class ConnectionHelper<T extends Connector> extends BaseHelper<T>
{
     ...
     *
     * @param response The outbound message.
     */
     ...
     * @throws IOException
     */
    protected Connection<T> checkout(SocketChannel socketChannel, ConnectionController controller, InetSocketAddress socketAddress) throws IOException
    {
     ...
     * @throws IOException
     */
    protected abstract Connection<T> createConnection(SocketChannel socketChannel, ConnectionController controller, InetSocketAddress socketAddress) throws IOException;
    ...
    public void createConnectionPool()
    {
        if (isPooledConnection())
        {
            this.connectionPool = new ConnectionPool<T>(this, getInitialConnections());
        }
    }
    ...
    {
        return Integer.parseInt(getHelpedParameters().getFirstValue("socketTrafficClass", "0"));
