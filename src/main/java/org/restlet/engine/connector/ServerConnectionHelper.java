...
public abstract class ServerConnectionHelper extends ConnectionHelper<Server>
{
    ...
    {
        return new Connection<Server>(this, socketChannel, controller, socketAddress, getInboundBufferSize(), getOutboundBufferSize());
    }
    ...
    protected SocketAddress createSocketAddress() throws IOException
    {
        ...
        return new InetSocketAddress(getHelped().getAddress(), getHelped().getPort());
    }
    ...
    public synchronized void start() throws Exception
    {
        ...
        getLogger().info("Starting the internal " + getProtocols() + " server on port " + getHelped().getActualPort());
        super.start();
