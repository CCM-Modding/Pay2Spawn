...
public abstract class OutboundWay extends Way
{
     ...
     *
     * @param entityChannel The entity as a NIO readable byte channel.
     */
     ...
     *
     * @param entityChannelType The type of the entity channel.
     */
     ...
     *
     * @param entityKey The entity's NIO selection key.
     */
