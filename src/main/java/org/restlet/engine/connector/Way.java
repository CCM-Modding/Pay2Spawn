...
public abstract class Way implements SelectionListener, CompletionListener, BufferProcessor
{
     ...
     * @throws IOException
     */
    public abstract int onFill(Buffer buffer, Object... args) throws IOException;
     ...
     * received or sent.
     *
     * @param endDetected Indicates if the end of the socket channel was detected.
     */
     ...
     *
     * @param message The current message processed.
     */
     ...
     *
     * @param registration The NIO selection registration holding the link between the
     *                     connection and the way.
     */
