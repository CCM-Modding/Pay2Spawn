...
public abstract class HeaderWriter<V> extends StringWriter
{
     ...
     *
     * @param content The comment to write.
     * @return This writer.
     */
     ...
     *
     * @param extension The parameter to format as an extension.
     * @return This writer.
     */
     ...
     *
     * @param name    The product name token.
     * @param version The product version token.
     * @return This writer.
     */
     ...
     *
     * @param content The string to quote and write.
     * @return This writer.
     */
