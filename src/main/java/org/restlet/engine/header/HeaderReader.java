 ...
 *
 * @param <V> The header value target type. There can be multiple values for a
 *            single header.
...
public class HeaderReader<V>
{
     ...
     * @return The new named value.
     */
    private static <NV extends NamedValue<String>> NV createNamedValue(Class<NV> resultClass, String name, String value)
    {
        try
        {
     ...
     * @param values The target collection.
