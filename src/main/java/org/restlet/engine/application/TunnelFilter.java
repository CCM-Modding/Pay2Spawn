...
public class TunnelFilter extends Filter
{
    ...
    private static class HeaderReplacer
    {
         ...
         * @param headerOld       The facultative value of the current's request header to
         *                        match.
     ...
     *
     * @param userAgentPropertiesUrl The URL of the properties file that describe replacement
     *                               values based on the user agent string.
     * @param oldHeaderName          The name of the property that gives the value of the header to
     ...
     * @return
     */
    private List<HeaderReplacer> getheaderReplacers(final URL userAgentPropertiesUrl, String oldHeaderName, String newHeaderName)
    {
