...
public class StatusFilter extends Filter
{
     ...
     * @param overwriting Indicates whether an existing representation should be
     *                    overwritten.
     * @param email       Email address of the administrator to contact in case of
     *                    error.
     ...
     *
     * @param context       The context.
     * @param statusService The helped status service.
     */
    ...
    protected int doHandle(Request request, Response response)
    {
        ...
        {
            getLogger().log(Level.WARNING, "Exception or error caught in status service", t);
    ...
    protected Representation getRepresentation(Status status, Request request, Response response)
    {
        ...
        try
        {
            result = getStatusService().getRepresentation(status, request, response);
        }
        catch (Exception e)
        {
     ...
     * Indicates if existing representations should be overwritten.
     *
     * @param overwriting True if existing representations should be overwritten.
     */
