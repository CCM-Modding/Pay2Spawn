...
public class AnnotationInfo
{
     ...
     *
     * @param currentClass    The current class to walk up.
     * @param genericTypeName The generic type name to resolve.
     ...
     * Returns the actual type for a given generic type name.
     *
     * @param currentType     The current type to start with.
     * @param genericTypeName The generic type name to resolve.
     * @return The actual type.
     */
     ...
     * Constructor.
     *
     * @param resourceClass The class or interface that hosts the annotated Java method.
    ...
    public AnnotationInfo(Class<?> resourceClass, Method restletMethod, java.lang.reflect.Method javaMethod, String value)
    {
        ...
        try
        {
            m = resourceClass.getMethod(javaMethod.getName(), javaMethod.getParameterTypes());
        }
        catch (Exception e)
        {
            m = javaMethod;
    ...
    public boolean equals(Object other)
    {
        ...
        if (result && (other != this))
        {
            ...
            if (result)
            {
                result = ((getJavaMethod() == null) && (otherAnnotation.getJavaMethod() == null) || (getJavaMethod() != null) && getJavaMethod().equals(
            ...
            if (result)
            {
                result = ((getResourceClass() == null) && (otherAnnotation.getResourceClass() == null) || (getResourceClass() != null) && getResourceClass().equals(
            ...
            if (result)
            {
                result = ((getRestletMethod() == null) && (otherAnnotation.getRestletMethod() == null) || (getRestletMethod() != null) && getRestletMethod().equals(
            ...
            if (result)
            {
                result = ((getInput() == null) && (otherAnnotation.getInput() == null) || (getInput() != null) && getInput().equals(otherAnnotation.getInput()));
            }

            // Compare the output annotation value
            if (result)
            {
                result = ((getOutput() == null) && (otherAnnotation.getOutput() == null) || (getOutput() != null) && getOutput().equals(otherAnnotation.getOutput()));
            }

            // Compare the query annotation value
            if (result)
            {
                result = ((getQuery() == null) && (otherAnnotation.getQuery() == null) || (getQuery() != null) && getQuery().equals(otherAnnotation.getQuery()));
            }
        }
    ...
    {
        return getJavaActualType(javaMethodImpl.getParameterTypes()[index], javaMethodImpl.getGenericParameterTypes()[index]);
    }
    ...
    public List<Variant> getRequestVariants(MetadataService metadataService, org.restlet.service.ConverterService converterService)
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<Variant> getResponseVariants(MetadataService metadataService, org.restlet.service.ConverterService converterService)
    {
        List<Variant> result = null;
     ...
     */
    public boolean isCompatible(Method restletMethod, Form queryParams, Representation requestEntity, MetadataService metadataService, org.restlet.service.ConverterService converterService)
    {
        boolean result = true;
     ...
     * method described.
     */
    public boolean isCompatibleRequestEntity(Representation requestEntity, MetadataService metadataService, org.restlet.service.ConverterService converterService)
    {
        boolean result = true;
    ...
    {
        return "AnnotationInfo [javaMethod: " + javaMethod + ", resourceInterface: " + resourceClass + ", restletMethod: " + restletMethod + ", input: " + getInput() + ", output: " + getOutput() + ", query: " + getQuery() + "]";
    }
