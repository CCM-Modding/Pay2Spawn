...
public class AnnotationUtils
{
     ...
     *
     * @param descriptors          The annotation descriptors to update or null to create a new
     *                             one.
     * @param resourceClass        The class or interface that hosts the javaMethod.
     * @param initialResourceClass The class or interface that runs the javaMethod.
     * @param javaMethod           The Java method to inspect.
     ...
     * @param initialClass The class or interface that runs the javaMethod.
     * @return The annotation descriptors.
     */
     ...
     * @param javaMethod  The method to match.
     ...
     *
     * @param annotations      The list of annotations.
     * @param restletMethod    The method to match.
     * @param query            The query parameters.
     * @param entity           The request entity to match or null if no entity is provided.
     * @param metadataService  The metadata service to use.
     * @param converterService The converter service to use.
     * @return The annotation descriptor.
     */
    public static AnnotationInfo getAnnotation(List<AnnotationInfo> annotations, Method restletMethod, Form query, Representation entity, MetadataService metadataService, org.restlet.service.ConverterService converterService)
    {
        if (annotations != null)
        {
            for (AnnotationInfo annotationInfo : annotations)
            {
                if (annotationInfo.isCompatible(restletMethod, query, entity, metadataService, converterService))
                {
                    return annotationInfo;
                }
            }
     ...
     *
     * @param clazz The resource class to introspect.
