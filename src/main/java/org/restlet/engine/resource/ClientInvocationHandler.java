...
public class ClientInvocationHandler<T> implements InvocationHandler
{
    ...
    public Object invoke(Object proxy, java.lang.reflect.Method javaMethod, Object[] args) throws Throwable
    {
        ...
        {
            AnnotationInfo annotationInfo = AnnotationUtils.getAnnotation(annotations, javaMethod);
            ...
            if (annotationInfo != null)
            {
                ...
                {
                    List<Variant> responseVariants = annotationInfo.getResponseVariants(getClientResource().getMetadataService(),
