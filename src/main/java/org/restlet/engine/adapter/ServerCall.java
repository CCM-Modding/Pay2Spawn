...
public abstract class ServerCall extends Call
{
     ...
     * @throws IOException if the Response could not be written to the network.
     */
     ...
     *
     * @param entity               The representation to write as entity of the body.
     * @param responseEntityStream The response entity stream or null if a channel is used.
     * @throws IOException
     */
     ...
     *
     * @param response   The response.
     * @param headStream The output stream to write to.
     * @throws IOException
     */
