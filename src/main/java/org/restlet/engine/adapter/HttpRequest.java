...
public class HttpRequest extends Request
{
    ...
    public static void addHeader(Request request, String headerName, String headerValue)
    {
        ...
        {
            ((HttpRequest) request).getHeaders().add(new Header(headerName, headerValue));
        }
    }
    ...
    public List<RecipientInfo> getRecipientsInfo()
    {
        ...
        {
            for (String header : getHttpCall().getRequestHeaders().getValuesArray(HeaderConstants.HEADER_VIA))
            {
