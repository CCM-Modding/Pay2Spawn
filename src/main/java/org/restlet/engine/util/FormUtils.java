...
public class FormUtils
{
     ...
     * @param decode       If true, the name and values are decoded with the given
     ...
     * @param decode       Indicates if the parameters should be decoded using the given
     *                     character set.
     * @return The parameter.
     * @throws IOException
     */
    ...
    {
        return new FormReader(query, characterSet, separator, decode).readFirstParameter(name);
    }
     ...
     * If multiple values are found, a list is created and set in the map.
     *
     * @param parametersString The query string.
     * @param parameters       The parameters map controlling the reading.
     * @param characterSet     The supported character encoding.
     * @param separator        The separator character to append between parameters.
     * @param decode           Indicates if the parameters should be decoded using the given
    ...
    {
        new FormReader(parametersString, characterSet, separator, decode).readParameters(parameters);
    }
     ...
     * @param decode Indicates if the parameters should be decoded.
     */
