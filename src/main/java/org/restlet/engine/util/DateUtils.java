...
public final class DateUtils
{
     ...
     */
    public static final List<String> FORMAT_RFC_822 = unmodifiableList("EEE, dd MMM yy HH:mm:ss z",
     ...
     *
     * @param date    The date to format.
     * @param formats The array of date formats to use.
     * @return The formatted date.
     */
     ...
     *
     * @param date The modifiable date.
     ...
     * @param array to be converted into an unmodifiable list
