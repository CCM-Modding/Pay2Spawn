...
public class FormReader
{
     ...
     * @throws IOException if the stream of the representation could not be opened.
     */
     ...
     * @param separator        The separator character used between parameters.
     */
     ...
     *
     * @param parametersString The parameters string.
     * @param characterSet     The supported character encoding. Set to null to leave the
     *                         data encoded.
     * @param separator        The separator character used between parameters.
     */
     ...
     *
     * @param parameters The target parameter series.
     */
