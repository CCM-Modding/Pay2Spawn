...
public class StringUtils
{
    ...
    private static class CharacterEntity
    {
         ...
         * Constructor.
         *
         * @param numericValue The numeric value of the entity.
    ...
    private static class CharacterEntitySolver
    {
         ...
         *
         * @param value The numeric value of the entity.
         * @param name  The name of the entity.
         * @return The solver.
         */
     ...
     * rules.
     *
     * @param str The {@link String} to encode.
     ...
     * decoding rules.
     *
     * @param str The {@link String} to decode.
