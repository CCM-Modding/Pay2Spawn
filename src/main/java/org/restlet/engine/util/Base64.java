...
public class Base64
{
     ...
     *
     * @param chars The characters array to decode.
     ...
     *
     * @param chars    The characters array to encode.
     * @param newlines Indicates whether or not newlines are desired.
     * @return The encoded string.
     */
     ...
     *
     * @param chars    The characters array to encode.
     * @param charset  The character set to use for the character to byte conversion.
     * @param newlines Indicates whether or not newlines are desired.
     * @return The encoded string.
     */
