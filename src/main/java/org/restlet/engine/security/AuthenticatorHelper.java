...
public abstract class AuthenticatorHelper extends Helper
{
     ...
     *
     * @param cw          The header writer to update.
     ...
     *
     * @param challenge   The challenge response to update.
     * @param request     The parent request.
     * @param httpHeaders The current request HTTP headers.
     */
     ...
     * Indicates if client side authentication is supported.
     *
     * @param clientSide True if client side authentication is supported.
     */
     ...
     * Indicates if server side authentication is supported.
     *
     * @param serverSide True if server side authentication is supported.
     */
