...
public class ReadableBufferedChannel extends BufferedSelectionChannel<ReadableSelectionChannel> implements ReadableSelectionChannel, CompletionListener
{
     ...
     *
     * @param buffer The IO buffer to fill.
     * @param args   The optional arguments to pass back to the callbacks.
     ...
     * reached.
     *
     * @param eofDetected Indicates if the end of network connection was detected.
     */
     ...
     * Indicates if the end of the channel has been reached.
     *
     * @param endReached True if the end of the channel has been reached.
     */
