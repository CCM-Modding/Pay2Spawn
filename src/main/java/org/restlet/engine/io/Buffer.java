...
public class Buffer
{
     ...
     * @param direct     Indicates if a direct NIO buffer should be created.
     ...
     * Constructor.
     *
     * @param byteBuffer The byte buffer wrapped.
     */
     ...
     *
     * @param byteBuffer      The byte buffer wrapped.
     * @param byteBufferState The initial byte buffer state.
     */
     ...
     *
     * @param targetArray The target byte array.
     * @param offset      The target offset.
     * @param length      The number of bytes to drain.
     */
     ...
     *
     * @param targetBuffer The target buffer.
     * @param maxDrained   The maximum number of bytes drained by this call or 0 for
     *                     unlimited length.
     * @return The number of bytes added to the target buffer.
     */
     ...
     *
     * @param sourceBuffer The source buffer.
     * @param maxFilled    The maximum number of bytes filled by this call or 0 for
     *                     unlimited length.
     * @return The number of bytes added from the source buffer.
     */
     ...
     * automatically made.
     *
     * @param processor  The IO processor to callback.
     * @param maxDrained The maximum number of bytes drained by this call or 0 for
     *                   unlimited length.
     * @param args       The optional arguments to pass back to the callbacks.
        ...
        synchronized (getLock())
        {
            ...
            if (Context.getCurrentLogger().isLoggable(Level.FINEST))
            {
                Context.getCurrentLogger().log(Level.FINEST,
                        "Ending process of buffer " + this + ". Result: " + result + ", try again: " + tryAgain + ", can loop: " + processor.canLoop(this,
                                args) + ", total filled: " + totalFilled);
            }
     ...
     *
     * @param byteBufferState The byte buffer IO state.
     */
