...
public class ReadableChunkingChannel extends WrapperChannel<ReadableByteChannel> implements ReadableByteChannel
{
     ...
     * @param maxBufferSize The total available size that can be read from the source
     *                      channel.
     */
     ...
     *
     * @param chunkDataSize The chunk data size value.
     * @param targetBuffer  The destination buffer.
