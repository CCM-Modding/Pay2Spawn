...
public class ReadableSizedSelectionChannel extends ReadableBufferedChannel
{
     ...
     * @param availableSize      The total available size that can be read from the source
     *                           channel.
     ...
     *
     * @param availableSize The remaining size that should be read from the source
     *                      channel.
     */
