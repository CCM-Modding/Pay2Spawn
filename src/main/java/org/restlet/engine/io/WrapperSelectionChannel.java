...
public class WrapperSelectionChannel<T extends SelectionChannel> extends WrapperChannel<T> implements SelectionChannel
{
     ...
     * Constructor.
     *
     * @param wrappedChannel The wrapped channel.
     */
     ...
     *
     * @param wrappedChannel The wrapped channel.
     * @param registration   The selection registration.
     */
     ...
     *
     * @param registration The NIO registration.
     */
    ...
    {
        return "WrapperSelectionChannel [toString()=" + super.toString() + ", registration=" + registration + "]";
    }
