...
public class ReadableChunkedChannel extends ReadableBufferedChannel
{
     ...
     * Constructor.
     *
     * @param completionListener The listener to callback upon reading completion.
     * @param buffer             The source byte buffer, typically remaining from previous read
     *                           processing.
    ...
    public ReadableChunkedChannel(CompletionListener completionListener, Buffer buffer, ReadableSelectionChannel source, WakeupListener wakeupListener)
    {
        ...
        {
            Context.getCurrentLogger().log(Level.FINER, "ReadableChunkedChannel created from: " + source + ". Registration: " + getRegistration());
        }
     ...
     *
     * @param buffer     The IO buffer to drain.
     * @param maxDrained The maximum number of bytes drained by this call.
     ...
     *
     * @param lineBuilderState The line builder state.
     */
     ...
     * channel.
     *
     * @param remainingChunkSize The remaining chunk size that should be read from the source
     *                           channel.
     */
