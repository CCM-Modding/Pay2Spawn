...
public class DefaultConverter extends ConverterHelper
{
    ...
    public List<Class<?>> getObjectClasses(Variant source)
    {
        ...
        if (source.getMediaType() != null)
        {
            ...
            if ((ObjectRepresentation.VARIANT_OBJECT_BINARY_SUPPORTED && MediaType.APPLICATION_JAVA_OBJECT.equals(mediaType)) || (ObjectRepresentation.VARIANT_OBJECT_XML_SUPPORTED && MediaType.APPLICATION_JAVA_OBJECT_XML.equals(
                    mediaType)))
            {
    ...
    public Representation toRepresentation(Object source, Variant target, Resource resource) throws IOException
    {
        ...
        else if (source instanceof Serializable)
        {
            result = new ObjectRepresentation<Serializable>((Serializable) source,
                    MediaType.getMostSpecific(target.getMediaType(), MediaType.APPLICATION_OCTET_STREAM));
        }
