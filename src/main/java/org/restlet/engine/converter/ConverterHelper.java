...
public abstract class ConverterHelper extends Helper
{
     ...
     *
     * @param objectClasses The object classes list to update or null.
     ...
     *
     * @param variants    The variants list to update or null.
     * @param userVariant The variant to add if not null.
     ...
     * @param variants      The variants list to update.
     */
     ...
     * @param resource The calling resource.
     ...
     * @param target   The expected class of the Java object.
     * @param resource The calling resource.
     * @return The affinity score of this helper.
     */
     ...
     *
     * @param preferences The media type preferences.
     * @param mediaType   The media type to update to add to the preferences.
     * @param score       The media type score to use as a quality score.
     */
