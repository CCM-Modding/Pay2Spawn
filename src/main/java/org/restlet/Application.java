...
public class Application extends Restlet
{
     ...
     *
     * @param clientRootClass The client root {@link ServerResource} subclass.
     * @deprecated Use {@link #setOutboundRoot(Class)} instead
     */
    @Deprecated
    public synchronized void setClientRoot(Class<? extends ServerResource> clientRootClass)
    {
     ...
     *
     * @param connegService The content negotiation service.
     */
     ...
     *
     * @param decoderService The decoder service.
     */
     ...
     *
     * @param inboundRootClass The inbound root Resource class.
     */
    public synchronized void setInboundRoot(Class<? extends ServerResource> inboundRootClass)
    {
     ...
     *
     * @param inboundRoot The inbound root Restlet.
     */
     ...
     *
     * @param outboundRootClass The client root {@link ServerResource} subclass.
     */
    public synchronized void setOutboundRoot(Class<? extends ServerResource> outboundRootClass)
    {
     ...
     *
     * @param outboundRoot The outbound root Restlet.
     */
     ...
     *
     * @param rangeService The range service.
     */
