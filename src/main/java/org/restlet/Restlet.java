...
public abstract class Restlet implements Uniform
{
     ...
     *
     * @param restlet The Restlet with a changed context.
     ...
     * parameter.
     *
     * @param resourceClass The target {@link org.restlet.resource.ServerResource} class
     *                      to find.
     * @return The new finder instance.
     * @see org.restlet.resource.Finder#createFinder(Class, Class, Context,
     * Logger)
     */
    public org.restlet.resource.Finder createFinder(Class<? extends org.restlet.resource.ServerResource> resourceClass)
    {
     ...
     * {@link Application#setInboundRoot(Class)} methods.
     *
     * @param finderClass The finder class to instantiate.
     */
