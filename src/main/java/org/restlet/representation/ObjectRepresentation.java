 ...
 *
 * @param <T> The class to serialize, see {@link Serializable}
...
public class ObjectRepresentation<T extends Serializable> extends OutputRepresentation
{
     ...
     * not.
     */
    public static final boolean VARIANT_OBJECT_BINARY_SUPPORTED = Boolean.getBoolean(
     ...
     *
     * @param serializedRepresentation The serialized representation.
     * @param classLoader              The class loader used to read the object.
     * @throws IOException
     * @throws ClassNotFoundException
     * @throws IllegalArgumentException
     */
    ...
    {
        this(serializedRepresentation, classLoader, VARIANT_OBJECT_BINARY_SUPPORTED, VARIANT_OBJECT_XML_SUPPORTED);
    }
     ...
     * @param serializedRepresentation     The serialized representation.
     * @param classLoader                  The class loader used to read the object.
     * @param variantObjectBinarySupported Indicates whether the JavaBeans binary deserialization is
     *                                     supported or not.
     * @param variantObjectXmlSupported    Indicates whether the JavaBeans XML deserialization is
     *                                     supported or not.
     * @throws IOException
     * @throws ClassNotFoundException
     * @throws IllegalArgumentException
    ...
    public ObjectRepresentation(Representation serializedRepresentation, final ClassLoader classLoader, boolean variantObjectBinarySupported, boolean variantObjectXmlSupported) throws IOException, ClassNotFoundException, IllegalArgumentException
    {
        ...
        if (MediaType.APPLICATION_JAVA_OBJECT.equals(serializedRepresentation.getMediaType()))
        {
            ...
            if (classLoader != null)
            {
                ...
                {
                    @Override
                    protected Class<?> resolveClass(java.io.ObjectStreamClass desc) throws java.io.IOException, java.lang.ClassNotFoundException
                    {
