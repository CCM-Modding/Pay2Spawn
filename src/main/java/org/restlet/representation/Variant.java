...
public class Variant
{
    ...
    public boolean equals(Object other)
    {
        ...
        if (result && (other != this))
        {
            ...
            if (result)
            {
                result = ((getCharacterSet() == null) && (otherVariant.getCharacterSet() == null) || (getCharacterSet() != null) && getCharacterSet().equals(
            ...
            if (result)
            {
                result = ((getLocationRef() == null) && (otherVariant.getLocationRef() == null) || (getLocationRef() != null) && getLocationRef().equals(
