...
public class DigesterRepresentation extends WrapperRepresentation
{
     ...
     * {@link #isTransient}
     *
     * @param algorithm The algorithm used to compute the digest to compare with. See
     ...
     * {@link #isTransient}
     *
     * @param algorithm The algorithm used to compute the digest. See constant values
