...
public class Request extends Message
{
    ...
    public boolean isEntityAvailable()
    {
        ...
        // platform.
        boolean result = (Method.GET.equals(getMethod()) || Method.HEAD.equals(getMethod()) || Method.DELETE.equals(getMethod()));
        if (result)
        {
            return false;
        }
     ...
     * parameter series.
     *
     * @param cookies A series of cookies provided by the client.
     */
     ...
     *
     * @param maxForwards The maximum number of intermediaries.
     */
     ...
     * "Proxy-Authorization" header.
     *
     * @param challengeResponse The authentication response sent by a client to a proxy.
     */
    ...
    public void setResourceRef(String resourceUri)
    {
        if (getResourceRef() != null)
        {
            ...
            setResourceRef(new Reference(getResourceRef().getBaseRef(), resourceUri));
        }
        else
        {
     ...
     *
     * @param rootRef The application root reference.
     */
